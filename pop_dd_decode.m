...
if nArgs/2 ~= length(cfg); 
    ...
    uilist = { ...
      ...
      { 'Style', 'popupmenu', 'string', 'none|Bonferroni|Holm-Bonferroni|Strong FWER Control Permutation Test|Cluster-Based Permutation Test|KTMS Generalised FWER|Benjamini-Hochberg FDR|Benjamini-Krieger-Yekutieli FDR|Benjamini-Yekutieli FDR' 'tag' 'multcompstats' 'value' double(cfg.multcompstats)} ...   
    };
