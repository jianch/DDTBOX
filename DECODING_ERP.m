...
if STUDY.cross==0 
    fprintf('DCG %d will be analised. \n',STUDY.dcg_todo);                
elseif STUDY.cross>0
    fprintf('DCG %d and %d will be analised for cross-condition classification. \n',STUDY.dcg_todo(1), STUDY.dcg_todo(2));
end
...
work_data=eval(SLIST.data_struct_name);
...
STUDY.nconds=size(reduced_data,3);
clear work_data;
