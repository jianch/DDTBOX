...
%
% More information about each analysis and plotting parameter, as well as 
% a tutorial on performing group analyses, can be found in the DDTBOX wiki,
...
% Set which subjects datasets to decode, e.g. [1:10] for first ten subjects
sbjs_todo = [1:10];
